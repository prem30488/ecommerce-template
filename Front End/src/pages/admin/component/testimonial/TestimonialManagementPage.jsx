...
const TestimonialManagementPage = () => {
  ...
  if(privileges && privileges.testimonials === true || currentUser && currentUser.roles[0].name === "ROLE_SUPERADMIN"){
  ...
  return (
    ...
    <Paper elevation={3} style={{ padding: '20px' }}>
      <Typography variant="h5" align="center">Testimonial Management</Typography>
