      ...
      <div className="frequent-card-content flex-grow flex flex-col justify-between p-6">
        <div>
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              <div className="fbc-review-pill flex items-center gap-1.5 mb-2 bg-amber-50 border-amber-100 px-2 py-0.5 rounded-full">
                <span className="text-[9px] font-black text-amber-600 uppercase tracking-widest">Bestseller</span>
              </div>
              <div className="frequent-card-brand">{product.brand || 'Heritage Choice'}</div>
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tighter">({product.reviews?.length || 12} Authentic Reviews)</span>
          </div>
        ...
        <div className="frequent-card-footer mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
          <div className="flex flex-col">
            ...
            <span className="text-2xl font-black text-rose-600 tracking-tighter">₹{price}</span>
          </div>
