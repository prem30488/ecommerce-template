...
import './premiumcard-carousel.css';
            ...
            <div className="frequent-card" style={{ minHeight: "420px", display: "flex", flexDirection: "column" }}>
                ...
                <div className="frequent-card-content flex-grow flex flex-col justify-between">
                    <div>
                        ...
                        <div className="frequent-card-image" style={{ minHeight: '100%', height: '100%', width: '100%', display: 'flex', position: "relative", maxHeight: "100%", maxWidth: "100%" }}>
                            {(product.cardCarouselImages?.length || product.image || product.img || product.ProductImages?.length) ? (
                                ...
                                <img src={'https://placehold.co/1200x600?text=No+Image'} alt={product.title} title={COMPANY_INFO.name} loading="lazy" style={{ height: '100%', width: '100%', objectFit: 'contain' }} />
                            )}
                            {/* Action icons column */}
                    ...
                    <div className="parth" style={{ marginTop: '16px' }}>
                        ...
                        <img src="/images/iso.png" alt="ISO" title={COMPANY_INFO.name} className="pc-badge-desktop" style={{ height: '70px', width: '200px', marginLeft: "40px", verticalAlign: "top" }} />
                        <img src="/images/time.png" alt="Delievry time" title={COMPANY_INFO.name} className="pc-badge-desktop" style={{ height: '70px', width: '350px', marginLeft: "20px", verticalAlign: "top" }} />
