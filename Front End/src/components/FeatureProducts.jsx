...
const FeatureProducts = () => {
  ...
  const featuredProducts = useMemo(() => {
    return products ? products.filter((product) => product.featured === true && product.active === true) : [];
  }, [products]);
      ...
      <div className="flex justify-between gap-10">
        <div className="w-full">
          <nav className="premium-breadcrumbs" style={{ 
            ...
            <span className="premium-breadcrumb-current font-medium">Featured Products</span>
          </nav>
